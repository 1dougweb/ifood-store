...
const evolutionApiUrl = computed(() => props.evolutionApiUrl);
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head title="Configurações de Integrações" />
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall
                    title="Integrações"
                        ...
                        <div class="mt-4 space-y-2 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-mono text-xs">
                                    {{ evolutionApiUrl || 'Não configurado' }}
                                </span>
                            </div>
                            <div class="flex justify-between">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Webhooks do iFood</CardTitle>
                        <CardDescription>
